...
await runSafeCli(() => {
  ...
  const prepared = prepareAdminDeployment({
    ...
    rssAutomaticCutoffIso: process.env.F1_ADMIN_RSS_AUTOMATIC_CUTOFF_ISO,
    xPageAutomaticCutoffIso: process.env.F1_ADMIN_X_PAGE_AUTOMATIC_CUTOFF_ISO,
    xPageTrustConfigurationPath: process.env.F1_ADMIN_X_PAGE_TRUST_CONFIGURATION_PATH,
    xPageTrustConfigurationSha256: process.env.F1_ADMIN_X_PAGE_TRUST_CONFIGURATION_SHA256,
    nodePath: process.execPath,
