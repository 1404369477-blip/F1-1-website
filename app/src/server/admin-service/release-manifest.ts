...
export const ADMIN_RELEASE_RUNTIME_FILES = [
  ...
  "src/admin-ui/ops.html",
  "src/admin-ui/ops.js",
  "src/admin-ui/settings.css",
  "src/admin-ui/settings.html",
  "src/admin-ui/settings.js",
  "src/admin-ui/sources.html",
  "src/admin-ui/sources.js",
  ...
  "src/server/admin-service/model-provider-probe.ts",
  "src/server/admin-service/model-credentials.ts",
  ...
  "src/server/internal-operation/recovery-fence-write.ts",
  ...
  "src/server/rss/private-credential-file.ts",
  ...
  "tsconfig.json",
  "migrations/rss-real/0014_rss_automatic_processing.sql",
  "migrations/rss-real/0016_rss_source_epoch_scope.sql",
  "src/server/rss-automatic/schema-identity.ts",
  "src/server/rss-automatic/source-epoch-schema-identity.ts",
  "src/server/rss-automatic/source-epoch-migration.ts",
  "src/server/rss-automatic/source-state.ts",
  "src/server/rss-automatic/delivery-authority.ts",
  "src/server/rss-automatic/contract.ts",
  "src/server/rss-automatic/admission.ts",
  "src/server/rss-automatic/worker.ts",
  "src/server/rss-automatic/supervisor.ts",
  "src/server/rss-automatic/migration.ts",
  "src/server/review-real/automatic-pipeline.ts",
  "src/server/rss-automatic/cursor.ts",
  "src/server/rss-automatic/collector.ts",
  "scripts/rss-automatic-collect.ts",
  "src/server/x-page/admission-migration.ts",
  "src/server/x-page/admission-schema-identity.ts",
  "src/server/x-page/automatic-worker.ts",
  "src/server/x-page/runtime.ts",
  "src/server/x-page/cursor.ts",
  "src/server/review-real/automatic-delivery.ts",
  "src/server/admin-service/automatic-coordinator.ts",
  "src/server/x-page/capture-artifacts.ts",
  "src/server/x-page/content-authority.ts",
  "src/server/x-page/current-fences.ts",
  "src/server/x-page/delivery-authority.ts",
  "src/server/x-page/deployment-trust.ts",
  "src/server/x-page/import-port.ts",
  "src/server/x-page/model-transport.ts",
  "src/server/x-page/private-artifact-file.ts",
  "src/server/x-page/producer-receipt-ledger.ts",
  "src/server/x-page/refinement.ts",
  "src/server/x-page/source-authority.ts",
  "src/server/x-page/trusted-capture.ts",
  "src/server/x-page/trusted-importer.ts",
  "migrations/rss-real/0017_x_page_production_admission.sql",
] as const;

const ADMIN_RELEASE_LEGACY_BOOTSTRAP_PATH = "scripts/public-release-bootstrap.ts" as const;
export const ADMIN_RELEASE_RUNTIME_FILE_COUNT = 207 as const;
export const ADMIN_RELEASE_RUNTIME_PATH_SET_SHA256 = "5cbcc890e44042af7018d029bbbb7b4883abac5ffbb88ad0a42e974a5f28c309" as const;
...
export const ADMIN_RUNTIME_CLOSURE_SPEC = Object.freeze({
  ...
  staticAssets: Object.freeze([
    ...
    Object.freeze({ from: "src/admin-ui/index.html", request: "/admin/ops", target: "src/admin-ui/ops.html" }),
    Object.freeze({ from: "src/admin-ui/index.html", request: "/admin/reviews", target: "src/admin-ui/index.html" }),
    Object.freeze({ from: "src/admin-ui/index.html", request: "/admin/sources", target: "src/admin-ui/sources.html" }),
    Object.freeze({ from: "src/admin-ui/index.html", request: "/admin/x-submissions", target: "src/admin-ui/x-management.html" }),
    Object.freeze({ from: "src/admin-ui/index.html", request: "/admin/settings", target: "src/admin-ui/settings.html" }),
    Object.freeze({ from: "src/admin-ui/ops.html", request: "/admin/assets/app.css", target: "src/admin-ui/app.css" }),
    Object.freeze({ from: "src/admin-ui/ops.html", request: "/admin/assets/ops.js", target: "src/admin-ui/ops.js" }),
    Object.freeze({ from: "src/admin-ui/ops.html", request: "/admin/reviews", target: "src/admin-ui/index.html" }),
    Object.freeze({ from: "src/admin-ui/ops.html", request: "/admin/ops", target: "src/admin-ui/ops.html" }),
    Object.freeze({ from: "src/admin-ui/ops.html", request: "/admin/sources", target: "src/admin-ui/sources.html" }),
    Object.freeze({ from: "src/admin-ui/ops.html", request: "/admin/x-submissions", target: "src/admin-ui/x-management.html" }),
    Object.freeze({ from: "src/admin-ui/ops.html", request: "/admin/settings", target: "src/admin-ui/settings.html" }),
    Object.freeze({ from: "src/admin-ui/sources.html", request: "/admin/assets/app.css", target: "src/admin-ui/app.css" }),
    Object.freeze({ from: "src/admin-ui/sources.html", request: "/admin/assets/sources.js", target: "src/admin-ui/sources.js" }),
    Object.freeze({ from: "src/admin-ui/sources.html", request: "/admin/reviews", target: "src/admin-ui/index.html" }),
    Object.freeze({ from: "src/admin-ui/sources.html", request: "/admin/ops", target: "src/admin-ui/ops.html" }),
    Object.freeze({ from: "src/admin-ui/sources.html", request: "/admin/sources", target: "src/admin-ui/sources.html" }),
    Object.freeze({ from: "src/admin-ui/sources.html", request: "/admin/x-submissions", target: "src/admin-ui/x-management.html" }),
    Object.freeze({ from: "src/admin-ui/sources.html", request: "/admin/x-accounts", target: "src/admin-ui/x-management.html" }),
    Object.freeze({ from: "src/admin-ui/sources.html", request: "/admin/settings", target: "src/admin-ui/settings.html" }),
    ...
    Object.freeze({ from: "src/admin-ui/x-management.html", request: "/admin/ops", target: "src/admin-ui/ops.html" }),
    Object.freeze({ from: "src/admin-ui/x-management.html", request: "/admin/sources", target: "src/admin-ui/sources.html" }),
    Object.freeze({ from: "src/admin-ui/x-management.html", request: "/admin/x-submissions", target: "src/admin-ui/x-management.html" }),
    Object.freeze({ from: "src/admin-ui/x-management.html", request: "/admin/settings", target: "src/admin-ui/settings.html" }),
    Object.freeze({ from: "src/admin-ui/settings.html", request: "/admin/assets/app.css", target: "src/admin-ui/app.css" }),
    Object.freeze({ from: "src/admin-ui/settings.html", request: "/admin/assets/settings.css", target: "src/admin-ui/settings.css" }),
    Object.freeze({ from: "src/admin-ui/settings.html", request: "/admin/assets/settings.js", target: "src/admin-ui/settings.js" }),
    Object.freeze({ from: "src/admin-ui/settings.html", request: "/admin/ops", target: "src/admin-ui/ops.html" }),
    Object.freeze({ from: "src/admin-ui/settings.html", request: "/admin/reviews", target: "src/admin-ui/index.html" }),
    Object.freeze({ from: "src/admin-ui/settings.html", request: "/admin/sources", target: "src/admin-ui/sources.html" }),
    Object.freeze({ from: "src/admin-ui/settings.html", request: "/admin/x-submissions", target: "src/admin-ui/x-management.html" }),
    Object.freeze({ from: "src/admin-ui/settings.html", request: "/admin/settings", target: "src/admin-ui/settings.html" })
  ])
});
